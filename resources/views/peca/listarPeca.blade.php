    ...
    <div class="containerHomeAll">
        <div class="containerInfoAll">
            <div class="containerTarefas">
                <h1 class="tarefas">Aqui estão todas as peças cadastradas</h1>
                @if (session('msg'))
            ...
            <div class="containerServicos">
                @if ($pecas->isEmpty())
                    <div class="containerTarefas">
                        <h1 class="tarefas">Não há peças cadastrados</h1>
                    </div>
                @endif
                @foreach ($pecas as $peca)
                    <div class="containerServicoInfo">
                        <div class="containerInfo">
                            <h1 class="infoServico">Peça: <p class="info">{{ $peca->tipo_peca }}</p>
                            </h1>
                        </div>
                        <div class="containerInfo">
                            <h1 class="infoServico">Preço da Peça: <p class="info">R${{ $peca->preco }}</p>
                            </h1>
                        </div>
